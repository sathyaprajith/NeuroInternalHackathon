...
const TabForm = () => {
  ...
  return (
    <div className="w-full min-h-screen overflow-x-hidden" style={{ background: 'linear-gradient(135deg, #f8f8f8 0%, #efefef 100%)' }}>
      {/* Top Header Bar */}
      <div className="w-full shadow-sm" style={{ background: '#fff', borderTop: '4px solid #9b1c1c' }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-lg flex items-center justify-center text-white font-bold text-lg" style={{ background: '#9b1c1c' }}>N</div>
            <div>
              <p className="font-bold text-base leading-tight" style={{ color: '#1a1a1a' }}>Neuro</p>
              <p className="text-xs" style={{ color: '#888' }}>Intellectual & Educational Assessment Portal</p>
            </div>
          </div>
          <button
            type="button"
            ...
            style={{
              backgroundColor: isButtonHovered ? '#7f1616' : '#9b1c1c',
              color: 'white',
              transform: isButtonHovered ? 'scale(1.02)' : 'scale(1)',
            }}
          >
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
            ...
            {tabs.map((tab, index) => {
              ...
              return (
                <React.Fragment key={tab.id}>
                  ...
                  >
                    <div
                      className={`w-9 h-9 rounded-full flex items-center justify-center font-bold text-sm ${isActive ? 'step-active' : ''}`}
                      style={{
                        backgroundColor: isCompleted ? '#16a34a' : isActive ? '#9b1c1c' : '#e5e5e5',
                    ...
                    <div className="mt-2 text-center text-xs font-medium whitespace-nowrap" style={{ color: isActive ? '#9b1c1c' : isCompleted ? '#16a34a' : '#999' }}>
                      {tab.name}
                    </div>
                  </div>
                  {index < tabs.length - 1 && (
                    <div
                      ...
                      style={{
                        backgroundColor: currentIndex > index ? '#16a34a' : '#e5e5e5',
                        transition: 'background-color 0.3s ease',
                      }}
                    />
                  )}
        ...
        <div className="form-card">
          {/* Tab title */}
          <div className="mb-6 pb-4" style={{ borderBottom: '2px solid #f1f1f1' }}>
            <h2 className="text-xl font-bold" style={{ color: '#9b1c1c' }}>
